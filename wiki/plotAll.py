...
def transform_name(name, disabled=False):
    name_transforms = {
        'bleu_wmt': 'BLEU-WMT',
        'bleurt_wmt': 'BLEURT-base512-WMT',
        'bert_score_f_wmt': 'BERTScore-WMT',
        'bart_score_wmt': 'BARTScore-WMT',
        'bleu_ted': 'BLEU-TEDMT',
        'bleurt_ted': 'BLEURT-base512-TEDMT',
        'bert_score_f_ted': 'BERTScore-TEDMT',
        'bart_score_ted': 'BARTScore-TEDMT',
        'rouge2-f': 'ROUGE-2-CNNDM',
        'rougeL-f': 'ROUGE-L-CNNDM',
        'bert_score_f': 'BERTScore-CNNDM',
        'bart_score_avg_f': 'BARTScore-CNNDM',
        'unieval_coherence': 'UniEval-coherence(sum)-CNNDM',
        'unieval_consistency': 'UniEval-consistency(sum)-CNNDM',
        'unieval_fluency': 'UniEval-fluency(sum)-CNNDM',
        'unieval_relevance': 'UniEval-relevance(sum)-CNNDM',
        'unieval_overall': 'UniEval-overall(sum)-CNNDM',
        'mauve-gpt2': 'MAUVE-GPT2-base-Wiki',
        'mauve-roberta': 'MAUVE-RoBERTa-base-Wiki',
        'mauve-roberta-large': 'MAUVE-RoBERTa-large-Wiki',
        'gpt-ppl': 'GPT2-base-PPL-Wiki',
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument('--legend_fontsize', type=int, default=9)
    args = parser.parse_args()

    # change order as desired
    plot_order = [
        'rouge2-f',
        'rougeL-f',
        'bert_score_f',
    ...
    fig.subplots_adjust(top=0.75, bottom=0.15, left=0.01, right=0.95, wspace=0.3, hspace=0.3)
    ...
    for ax, subfolder in zip(axs, subfolders):
        ...
        ax.set_title(transform_name(subfolder, args.disable_transform), fontsize = 10)
